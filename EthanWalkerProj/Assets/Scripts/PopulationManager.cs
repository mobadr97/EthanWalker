...
public class PopulationManager : MonoBehaviour {
	...
	void OnGUI()
	{
		...
		GUI.Label(new Rect (10,100,200,30), "Agent Target: " + agentTarget, guiStyle);
		GUI.EndGroup ();
	}
	...
	void BreedNewPopulation()
	{
		...
		if(agentTarget == AgentTarget.Distance_Travelled){
			sortedList = population.OrderBy(o => o.GetComponent<Brain>().distanceTravelled).ToList();
		}else{
			sortedList = population.OrderBy(o => o.GetComponent<Brain>().timeAlive).ToList();
		}
